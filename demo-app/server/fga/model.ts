...
export const FGA_AUTH_MODEL = {
  ...
  type_definitions: [
    ...
    },
    {
        ...
        can_read: {
          union: {
            child: [
              ...
              { tupleToUserset: { tupleset: { relation: "owning_team" }, computedUserset: { relation: "manager" } } },
              { tupleToUserset: { tupleset: { relation: "owning_team" }, computedUserset: { relation: "member" } } },
            ],
          },
        },
        can_commit: {
      ...
      metadata: {
        relations: {
          ...
          owning_team: { directly_related_user_types: [{ type: "team" }] },
          can_read: {},
          can_commit: {},
        },
      },
    },
    {
      ...
      metadata: {
        relations: { reader: { directly_related_user_types: [{ type: "user" }] } },
      },
    },
  ],
} as const;
